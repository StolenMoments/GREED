...
- `추세`, `구름대 위치`, `MA 배열`, `매매 판정` 행은 반드시 포함하세요.
- 가격은 가능하면 숫자와 원 단위로 쓰고, 불가피하게 산정할 수 없을 때만 `없음`을 쓰세요.
...
### 2. 핵심 지지/저항선
- 1차 지지: 000원  근거: 지표명과 수치
- 2차 지지: 000원  근거: 지표명과 수치
- 1차 저항: 000원  근거: 지표명과 수치
- 2차 저항: 000원  근거: 지표명과 수치
